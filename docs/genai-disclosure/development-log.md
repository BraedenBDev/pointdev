...
1. **Initialized pnpm project.** Ran `pnpm init` in the project root.
...
6. **Verified build.** `pnpm build` succeeds, producing dist/ with correct manifest.json, service worker loader, sidepanel HTML, bundled assets, and icons.
