...
- ~~Manual verification in Chrome after reloading the extension~~ Done 2026-09-26: Braeden tested all session 15 fixes and the PDF export in Chrome; all working
- Markdown export still links to `screenshot-N.jpg` files that are never written
